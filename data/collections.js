...
TRIPS.collections = [
  {
    id: 'murugan', title: 'Six Abodes of Murugan', emoji: '🪶', blurb: 'Arupadai Veedu — all six, ticked off.', cover: 'tiruchendur',
    ids: ['thiruparankundram', 'tiruchendur', 'palani', 'swamimalai', 'thiruthani', 'pazhamudircholai']
  },
  {
    id: 'temples', title: 'Temples & shrines', emoji: '🛕', blurb: 'From Hoysala lace-work to Prambanan and Borobudur.', cover: 'thanjavur',
  ...
  {
    id: 'abroad', title: 'Countries & cities abroad', emoji: '✈️', blurb: 'From Singapore and Bali to the Grand Canyon, the Great Wall and Paris.', cover: 'paris',
  ...
  {
    id: 'treks', title: 'Treks & Climbs', emoji: '🥾', blurb: 'Steps, ridges and passes — where we earned the view on foot.', cover: 'hampta-pass',
    ids: ['nandi-hills', 'ramanagara', 'devarayanadurga', 'mandaragiri', 'gumi', 'hampta-pass', 'shravanabelagola', 'palani', 'melukote']
  },
  {
    id: 'beaches', title: 'Beaches, islands & coasts', emoji: '🏖️', blurb: 'Andaman sands to the three seas at Kanyakumari.', cover: 'phuket',
  ...
  {
    id: 'hills', title: 'Hill stations & mountains', emoji: '⛰️', blurb: 'Tea, mist, toy trains and the Alps.', cover: 'munnar',
  ...
  {
    id: 'forts', title: 'Forts & palaces', emoji: '🏰', blurb: 'Where kings, sultans and maharanas lived and fought.', cover: 'kumbhalgarh',
  ...
  {
    id: 'unesco', title: 'UNESCO World Heritage', emoji: '🏛️', blurb: 'The places the whole world agrees are special.', cover: 'agra',
  ...
  {
    id: 'ancient', title: 'Ancient marvels', emoji: '🗿', blurb: 'Older than a thousand years — caves, stupas and rock art.', cover: 'ajanta',
  ...
  {
    id: 'water', title: 'Waterfalls, lakes & rivers', emoji: '💦', blurb: 'Backwaters, alpine lakes and the roar of the Kaveri.', cover: 'niagara-falls',
  ...
  {
    id: 'wildlife', title: 'Wildlife & nature', emoji: '🐘', blurb: 'Hornbills, tahr, dolphins and vultures.', cover: 'kabini',
  ...
  {
    id: 'pilgrim', title: 'Pilgrim trails', emoji: '🙏', blurb: 'Char Dham corners, Sai Baba, Velankanni and more.', cover: 'tirupati',
  ...
  {
    id: 'food', title: 'Food towns', emoji: '🍛', blurb: 'Where the eating was half the trip.', cover: 'coll-food',
    ids: ['udupi', 'mangalore', 'madurai', 'hyderabad', 'mumbai', 'delhi', 'kochi', 'mysuru', 'coorg', 'agra', 'lonavala',
      'bangkok', 'singapore', 'paris', 'zurich']
  },
  {
    id: 'rides', title: 'Rides & journeys', emoji: '🚂', blurb: 'Toy trains, houseboats, rafts and cogwheels.', cover: 'coll-rides',
  ...
  {
    id: 'cities', title: 'Big cities', emoji: '🏙️', blurb: 'Skylines, bazaars and metro maps.', cover: 'coll-cities',
